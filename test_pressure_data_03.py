...
windCase = '10B'
number_of_closest_rollers = 3
angle_offset = 0#np.pi/6
saved_data = np.load(f"./Data from Ed/inner_ring_segment_pressure_{windCase}_closest_rollers_{number_of_closest_rollers}_angle_offset_{round(angle_offset, 2)}.npz")
